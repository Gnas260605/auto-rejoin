  ...
  const cards = [
    {
      ...
      value: stats.total,
      icon: Key,
      color: "text-zinc-400 bg-zinc-800/50 border-zinc-700/50",
      filter: null
    },
    {
      ...
      {cards.map((card, idx) => {
        ...
        return (
          <div
            ...
            className={`p-3.5 rounded-lg bg-zinc-900/60 border border-zinc-800 transition-colors ${
              card.filter ? "cursor-pointer hover:border-zinc-700 hover:bg-zinc-800/50" : ""
            }`}
          >
            ...
            <div className="mt-2 text-xl font-bold text-zinc-100 tracking-tight font-mono">
              {card.value}
            </div>
          </div>
        );
